...
public class TestJSON5Config extends CConfig {
    ...
    public @NotNull String getFileName() {
        return FernConfig.MOD_ID + "_json5";
    }
    ...
    public final CEnum<MaskType> block_mask_type = register(COMPLEX_THINGS, new CEnum<MaskType>(
            "mask_type",
            "This is enum that contains type of the mask below",
            MaskType.class,
            MaskType.WHITELIST)
    );
